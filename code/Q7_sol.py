...
Change the values for the kernels in the following lines.

In order for us to submit over 15 python files for one questions, we will tell you what to change.

In the report question 7, we have 3 tables. Each are labelled in the report.

For Column KER_C1:
            -Change the value in line 152 in Q7_sol.py file
            -Change the value in line 49 in the lenet_train_test_Q7.prototxt file


For Columns KER_C2:
            -Change the value in line 83 in the lenet_train_test_Q7.prototxt file



You need to change these respectively by the table in the report. I will email you about it.
...
'''------------------------Pre Processing Data---------------------'''
# my_root = '/home/ubuntu/Desktop/Caffe_Files/caffe_example/mnist'
# os.chdir(my_root)
# ----------------------------Be careful about the Directories------------------------------------
...
solver = caffe.SGDSolver('lenet_solver_Q7.prototxt')
...
print('\nRuntime: ' + str(round(endtime, 3)) + ' seconds')
"""
To minimize the number of files submitted, we will tell you which line of code to change.

This one is easy.

In the report table 5 contain different batch sizes. All you have to do is:

    Change the BATCH SIZE value in line 15 in the lenet_train_test.prototxt file.
...
solver = caffe.SGDSolver('lenet_solver_Q9.prototxt')
